...
@SequenceGenerator(name = "TIPO_TRATAMENTO_ID", sequenceName = "TIPO_TRATAMENTO_SEQ", allocationSize = 1, initialValue=1)
public class TipoTratamento implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "TIPO_TRATAMENTO_ID")
	private Long id;
