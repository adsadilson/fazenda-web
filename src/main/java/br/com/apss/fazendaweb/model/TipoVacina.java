...
@SequenceGenerator(name = "TIPO_VACINA_ID", sequenceName = "TIPO_VACINA_SEQ", allocationSize = 1, initialValue=1)
public class TipoVacina implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "TIPO_VACINA_ID")
	private Long id;
