...
@SequenceGenerator(name = "TIPO_PARTO_ID", sequenceName = "TIPO_PARTO_SEQ", allocationSize = 1, initialValue=1)
public class TipoParto implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "TIPO_PARTO_ID")
	private Long id;
